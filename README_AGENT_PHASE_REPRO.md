...
```text
experiments/deepagents_swebench_profile/profiles/<run>/kernel_analysis/summary.md
experiments/deepagents_swebench_profile/profiles/<run>/kernel_analysis/agent_phase_inference_bucket_summary.csv
```
