...
PROFILE_DIR="${PROFILE_DIR:-${REPO_ROOT}/experiments/raw/lpx_decode_split/profiles/${RUN_NAME}}"
RESULTS_ROOT="${RESULTS_ROOT:-${REPO_ROOT}/experiments/reports/lpx_decode_split/results/${RUN_NAME}}"
