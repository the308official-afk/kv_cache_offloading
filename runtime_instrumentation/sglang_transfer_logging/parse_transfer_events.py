                ...
                event_rows.writerow(
                    {
                        ...
                        "runtime_context_id": event.get("runtime_context_id", ""),
                        "sglang_request_id": event.get("sglang_request_id", ""),
                        "parent_run_id": event.get("parent_run_id", ""),
                        "task_instance_id": event.get("task_instance_id", ""),
                        "phase": event.get("phase", ""),
                        "agent_phase": event.get("agent_phase", ""),
                        "step_index": event.get("step_index", ""),
                        "step_title": event.get("step_title", ""),
                        "app_variant": event.get("app_variant", ""),
                        "hint_profile": event.get("hint_profile", ""),
                        "hint_probe_id": event.get("hint_probe_id", ""),
                        "request_metadata_source": event.get("request_metadata_source", ""),
                        "agent_hints_source": event.get("agent_hints_source", ""),
