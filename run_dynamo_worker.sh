...
SGLANG_TRANSFER_LOG_INDEX_PREVIEW="${SGLANG_TRANSFER_LOG_INDEX_PREVIEW:-0}"
SGLANG_TRANSFER_LOG_INDEX_PREVIEW_COUNT="${SGLANG_TRANSFER_LOG_INDEX_PREVIEW_COUNT:-32}"
SGLANG_TRANSFER_LOG_TOKEN_TENSOR_SYNC="${SGLANG_TRANSFER_LOG_TOKEN_TENSOR_SYNC:-0}"
SGLANG_TRANSFER_LOG_SYNC_TIMING="${SGLANG_TRANSFER_LOG_SYNC_TIMING:-0}"
SGLANG_TRANSFER_LOG_VERBOSE="${SGLANG_TRANSFER_LOG_VERBOSE:-0}"
...
sync timing: ${SGLANG_TRANSFER_LOG_SYNC_TIMING}
verbose log: ${SGLANG_TRANSFER_LOG_VERBOSE}
