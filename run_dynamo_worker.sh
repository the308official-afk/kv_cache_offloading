...
DYNAMO_CACHE_CONTAINER_DIR="${DYNAMO_CACHE_CONTAINER_DIR:-/models/hfcache}"
...
Environment overrides:
  ...
  DYNAMO_CACHE_CONTAINER_DIR Default: ${DYNAMO_CACHE_CONTAINER_DIR}
...
start_worker() {
  ...
  docker_args=(
    ...
    -v "${DYNAMO_CACHE_DIR}:${DYNAMO_CACHE_CONTAINER_DIR}"
    -e ETCD_ENDPOINTS="${ETCD_ENDPOINTS}"
    -e NATS_SERVER="${NATS_SERVER}"
    -e DYN_TOOL_CALL_PARSER="${DYN_TOOL_CALL_PARSER:-}"
    -e DYN_RUNTIME_JSON_LOGS="${DYN_RUNTIME_JSON_LOGS:-}"
    -e HF_HOME="${DYNAMO_CACHE_CONTAINER_DIR}"
    -e HUGGINGFACE_HUB_CACHE="${DYNAMO_CACHE_CONTAINER_DIR}/hub"
    -e TRANSFORMERS_CACHE="${DYNAMO_CACHE_CONTAINER_DIR}/hub"
...
hf cache host path: ${DYNAMO_CACHE_DIR}
hf cache container path: ${DYNAMO_CACHE_CONTAINER_DIR}
