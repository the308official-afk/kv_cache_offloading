...
: "${RETENTION_TRAJECTORY_PROMPT_PREFIX_MODE:=${RETENTION_TRAJECTORY_REPLAY_HEADER_MODE:-task_stage}}"
: "${RETENTION_TRAJECTORY_REPLAY_HEADER_MODE:=${RETENTION_TRAJECTORY_PROMPT_PREFIX_MODE}}"
...
export RETENTION_TRAJECTORY_PROMPT_PREFIX_MODE
export RETENTION_TRAJECTORY_REPLAY_HEADER_MODE
