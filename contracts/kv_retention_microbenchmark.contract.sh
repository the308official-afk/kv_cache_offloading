...
: "${RETENTION_REAL_REQUEST_UNITS_CSV:=${ROOT_DIR}/experiments/reports/latest_swebench_real_request_units.csv}"
: "${RETENTION_REAL_PROTECTED_REQUEST_UNIT_ID:=}"
: "${RETENTION_REAL_PROTECTED_PHASE_GROUPS:=plan act patch review}"
: "${RETENTION_REAL_DISTRACTOR_PHASE_GROUPS:=plan act patch review}"
: "${RETENTION_REAL_ALLOW_DISTRACTOR_REUSE:=0}"
...
export RETENTION_REAL_REQUEST_UNITS_CSV
export RETENTION_REAL_PROTECTED_REQUEST_UNIT_ID
export RETENTION_REAL_PROTECTED_PHASE_GROUPS
export RETENTION_REAL_DISTRACTOR_PHASE_GROUPS
export RETENTION_REAL_ALLOW_DISTRACTOR_REUSE
