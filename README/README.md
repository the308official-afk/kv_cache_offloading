...
```text
experiments/raw/lpx_decode_split/profiles/<run>/kernel_analysis/summary.md
experiments/raw/lpx_decode_split/profiles/<run>/kernel_analysis/lpx_what_if/summary.md
```
...
- `experiments/scripts/lpx_decode_split/profile_one_decode_case.sh`
- `experiments/scripts/lpx_decode_split/run_decode_sweep.py`
- `experiments/scripts/lpx_decode_split/analyze_nsys_sqlite.py`
- `experiments/scripts/lpx_decode_split/estimate_lpx_speedup.py`
- `runtime_instrumentation/prepare_instrumented_dynamo_source.sh`
- `runtime_instrumentation/build_instrumented_dynamo_images.sh`
